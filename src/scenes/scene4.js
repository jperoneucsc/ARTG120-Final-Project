...
class Scene4 extends Phaser.Scene {
    ...
    create()
    {
        ...
        platforms.create(200, 170, "platform2").setScale(1);


        const crates = this.physics.add.staticGroup();
        crates.create(110,315, "crate");
        crates.create(110,120, "crate");
        ...
        // Create Bear
        this.player = this.physics.add.sprite(2300, sceneHeight * 0.75, 'DarkBear').setScale(0.27).setSize(200,490).play('dark-idle');
